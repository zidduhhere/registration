          ...
          {papers.map((item, i) => {
            ...
            return (
              <div
                ...
                className={`absolute z-20 bottom-[10%] left-1/2 transition-all duration-300 ease-in-out flex items-center justify-center p-4 ${
              ...
              >
                <p className="text-center text-sm font-medium text-gray-800">{item}</p>
              </div>
            );
          })}
          <div
